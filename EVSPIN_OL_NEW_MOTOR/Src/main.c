...
#define OL_VOLTAGE_REFERENCE  20   // set the open loop voltage reference %. Related to the modulation ratio.
#define RAMP_DURATION_MS           1000  // set the open loop ramp duration to 1 second
...
//  MC_GetOccurredFaultsMotor1();
  ...
  // Set duty cycle
  OL_UpdateVoltage(&OpenLoop_ParamsM1, ((OL_VOLTAGE_REFERENCE * 32767) / 100));
