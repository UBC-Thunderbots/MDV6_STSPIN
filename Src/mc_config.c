...
PID_Handle_t PIDSpeedHandle_M1 =
{
  ...
  .wUpperIntegralLimit = (int32_t)(IQMAX/4) * (int32_t)SP_KIDIV,
  .wLowerIntegralLimit = -(int32_t)(IQMAX/4) * (int32_t)SP_KIDIV,
  .hUpperOutputLimit   = (int16_t)IQMAX/4,
  .hLowerOutputLimit   = -(int16_t)IQMAX/4,
...
PID_Handle_t PIDIqHandle_M1 =
{
  ...
  .wUpperIntegralLimit = (int32_t)(INT16_MAX/4) * TF_KIDIV, // Prevent overshoot with integral windup
  .wLowerIntegralLimit = (int32_t)(-INT16_MAX/4)* TF_KIDIV, // Prevent overshoot with integral windup
  .hUpperOutputLimit   = INT16_MAX / 4, // Lowered saturation limits
  .hLowerOutputLimit   = -INT16_MAX / 4, // Lowered saturation limits
